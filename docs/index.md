...
<div style="display: flex; flex-wrap: wrap; gap: 0.8rem; margin: 1.5rem 0;">
  <span style="padding: 0.4rem 1rem; background-color: #e3f2fd; color: #1976d2; border-radius: 20px; font-size: 0.9rem;">Java</span>
  <span style="padding: 0.4rem 1rem; background-color: #e3f2fd; color: #1976d2; border-radius: 20px; font-size: 0.9rem;">Spring Boot</span>
